...
const PreviewBanner = styled(Alert)(({ theme }) => ({
  borderRadius: '12px',
  marginBottom: '16px',
  background: theme.palette.mode === 'dark'
    ? 'rgba(124, 58, 237, 0.2)'
...
export default function PreviewQuiz() {
  ...
  const handleNextQuestion = () => {
    ...
    if (currentQuestionIndex < quiz.questions.length - 1) {
      ...
      // Preview completed - NO score saving to Firebase
    ...
    return (
      <GradientBackground>
        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }}>
          <Typography variant="h6" sx={{ color: 'white' }}>Loading quiz preview...</Typography>
        </Box>
      </GradientBackground>
    );
  }
    ...
    <GradientBackground>
      <GlassAppBar position="static" elevation={0}>
        <Toolbar>
          ...
          <VisibilityIcon sx={{ mr: 2, color: '#7c3aed', fontSize: 28 }} />
      ...
      <Container maxWidth="md" sx={{ py: 4, position: 'relative', zIndex: 1 }}>
        <PreviewBanner
          ...
          icon={<VisibilityIcon />}
        >
          <strong>Preview Mode</strong> - This is how students will see your quiz. Scores will not be saved.
        </PreviewBanner>
        ...
        {!quizStarted ? (
          <QuizStartCard sx={{ p: 5 }}>
            <Box sx={{ textAlign: 'center' }}>
              ...
              <Tooltip title="Begin the preview - timer will start" arrow placement="top">
                <StartButton
                  variant="contained"
                  size="large"
                  onClick={startQuiz}
          ...
          <Fade in timeout={600}>
            <ResultCard sx={{ p: 5, textAlign: 'center' }}>
              ...
              <Typography variant="body1" sx={{ color: theme.palette.text.secondary, mb: 3, fontStyle: 'italic' }}>
                (This score was not saved - preview mode only)
              </Typography>
              ...
              <Box sx={{ mt: 4, textAlign: 'center' }}>
                <Tooltip
                  title={selectedAnswer === null
                    ...
                    : (currentQuestionIndex < quiz.questions.length - 1 ? "Continue to next question" : "Complete preview")
                  }
                  arrow
                >
                  <span>
                    ...
                    >
                      {currentQuestionIndex < quiz.questions.length - 1 ? 'Next Question →' : 'Finish Preview ✓'}
                    </Button>
                  </span>
                </Tooltip>
              </Box>
